...
class HoverPower(Component):
    ...
    def __init__(self):
        ...
        self.add_param('Vehicle', val=u'helicopter', description='tiltwing, helicopter')
        self.add_param('rProp', val=1.4, description='radius of prop/rotor')
        self.add_param('W', val=2000.0, description='Weight')
        self.add_param('cruisePower_omega', val=122.0, description='Cruise data omega')
